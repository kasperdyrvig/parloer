...
{% exerciseItem %}
<audio-player data-file="greeting/greetings_07.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="course/uteqqilaaruk.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="greeting/greetings_18.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="language/paasinngilara.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="language/languages_06.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="language/languages_17.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="course/ajunngilaq.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="questionsanswers/common-questions_42.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="aboutgod/gud4.mp3" data-enable-slow="true"></audio-player>
...
{% exerciseItem %}
<audio-player data-file="godsname/gudsnavn3.mp3" data-enable-slow="true"></audio-player>
